...
//enable next step
$(function() {
	var acadyearlabel = document.getElementById("step1");
	var degreetypelabel = document.getElementById("step2");
	var selprgrmlabel = document.getElementById("step3");
	var reslabel = document.getElementById("step4");
	var slidersec = document.getElementById("slidercell");
	$(acadyearlabel).change(function() {
...
obj.preLoad = true;
var keyCodes = [],
konamiString = "38,38,40,40,37,39,37,39,66,65,13";
...
var keyCodes1 = [],
SonicString = "38,99,40,99,39,99,97,13";
$(document).keydown(function(e) {
	keyCodes1.push(e.keyCodes1);
	if (keyCodes1.toString().indexOf(SonicString) >= 0) {
		$(document).unbind('keydown', arguments.callee);

        // do something cool here
        obj.play();
        $('#warningModal').foundation('open');
        document.getElementById("konam").innerHTML = '';
    }
});
